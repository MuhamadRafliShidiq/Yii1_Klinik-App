...
class Pasien extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('tanggal_lahir, alamat , keterangan', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nama, tanggal_lahir, jenis_kelamin, alamat, keterangan, no_hp', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'pendaftaran' => array(self::HAS_MANY, 'Pendaftaran', 'id_pasien'),
		);
	}
