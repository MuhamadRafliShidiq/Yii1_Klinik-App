...
<div class="container mt-10 px-6 py-10">
    <div class="bg-gradient-to-r from-blue-500 to-purple-600 text-black p-8 rounded-xl shadow-lg mb-8">
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 12px 15px; font-weight: bold;">Nama Pegawai</td>
                    <td style="padding: 12px 15px;"><?php echo htmlspecialchars($model->nama); ?></td>
                </tr>
                <tr>
                    <td style="padding: 12px 15px; font-weight: bold;">Jabatan</td>
                    <td style="padding: 12px 15px;"><?php echo htmlspecialchars($model->jabatan); ?></td>
                </tr>
				<tr>
    ...
    <div class="action-buttons mt-8 text-center">
        <a href="<?php echo Yii::app()->createUrl('pegawai/update', ['id' => $model->id]); ?>" class="btn btn-warning mx-2 mt-4">Edit</a>
        <a href="<?php echo Yii::app()->createUrl('pegawai/index'); ?>" class="btn btn-secondary mx-2 mt-4">Kembali</a>
    </div>
</div>
